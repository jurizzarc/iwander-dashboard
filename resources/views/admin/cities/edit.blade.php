                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.cities.update', $city->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3">{{ old('description', $city->description) }}</textarea>
                        </div>
                        ...
                        <a href="{{ route('admin.cities.show', $city->id) }}" class="btn btn-link">Cancel</a>
